...
const EventCard: React.FC<EventCardProps> = ({ event, index }) => {
  ...
  return (
    <Card 
      className="event-card overflow-hidden h-full animate-in border-2 hover:border-pulse-purple/50 shadow-lg"
      ...
      <CardFooter className="border-t pt-3 mt-auto flex justify-between items-center">
        ...
        {event.eventUrl && (
          <Button variant="outline" size="sm" className="text-xs" asChild>
            <a href={event.eventUrl} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1">
